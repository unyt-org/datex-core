...
impl<'a> CompilationScope<'a> {
    ...
    fn insert_int(&mut self, int: i64) {
        if int <= CompilationScope::MAX_INT_8 && int >= CompilationScope::MIN_INT_8 {
            self.insert_int8(int as i8)
        } else if int <= CompilationScope::MAX_INT_16 && int >= CompilationScope::MIN_INT_16 {
            self.insert_int16(int as i16)
        } else if int <= CompilationScope::MAX_INT_32 && int >= CompilationScope::MIN_INT_32 {
