...
impl PartialEq for ExtendedBigDecimal {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            | (ExtendedBigDecimal::NegZero, ExtendedBigDecimal::NegZero)
...
impl ExtendedBigDecimal {
    pub fn is_zero(&self) -> bool {
        matches!(self, ExtendedBigDecimal::Zero | ExtendedBigDecimal::NegZero)
    }
    ...
    pub fn from_string(s: &str) -> Option<ExtendedBigDecimal> {
        match s {
            ...
            "nan" | "NaN" | "-nan" | "-NaN" => Some(ExtendedBigDecimal::NaN),
            _ => {
                let big_decimal = BigDecimal::from_str(s).ok()?;
                if big_decimal.is_zero() {
                    if s.starts_with('-') {
                        Some(ExtendedBigDecimal::NegZero)
                    } else {
    ...
    pub fn neg(&self) -> Self {
        match self {
            ...
            ExtendedBigDecimal::Zero => ExtendedBigDecimal::NegZero,
            ExtendedBigDecimal::NegZero => ExtendedBigDecimal::Zero,
...
impl Display for ExtendedBigDecimal {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ExtendedBigDecimal::NegZero => write!(f, "-0.0"),
...
impl TryFrom<BigDecimalType> for ExtendedBigDecimal {
    ...
    fn try_from(value: BigDecimalType) -> Result<Self, Self::Error> {
        match value {
            ...
            BigDecimalType::MinusZero => Ok(ExtendedBigDecimal::NegZero),
...
impl From<&ExtendedBigDecimal> for BigDecimalType {
    fn from(value: &ExtendedBigDecimal) -> Self {
        match value {
            ...
            ExtendedBigDecimal::NegZero => BigDecimalType::MinusZero,
...
impl ExtendedBigDecimal {
    pub fn try_into_f32(&self) -> Option<f32> {
        match self {
            ...
            ExtendedBigDecimal::NegZero => Some(-0.0),
...
impl SoftEq for ExtendedBigDecimal {
    fn soft_eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (ExtendedBigDecimal::NegZero, ExtendedBigDecimal::NegZero) => true,
...
impl Add for ExtendedBigDecimal {
    ...
    fn add(self, rhs: Self) -> Self::Output {
        match (self, rhs) {
            ...
            (ExtendedBigDecimal::NegZero, b)
            | (b, ExtendedBigDecimal::NegZero) => b,
            (ExtendedBigDecimal::Inf, ExtendedBigDecimal::NegInf)
            | (ExtendedBigDecimal::NegInf, ExtendedBigDecimal::Inf) => {
                ExtendedBigDecimal::NaN
            }
        ...
        match rhs {
            TypedDecimal::F32(value) => {
                match (self, value.into_inner()) {
                    ...
                    | (ExtendedBigDecimal::NegZero, 0.0) => {
                        ExtendedBigDecimal::Zero
                    }
...
mod tests {
    ...
    fn test_infinity() {
        ...
        let b = ExtendedBigDecimal::from(f64::INFINITY);
        assert!(matches!(b, ExtendedBigDecimal::Inf));

        let c = ExtendedBigDecimal::from_string("infinity").unwrap();
        assert!(matches!(c, ExtendedBigDecimal::Inf));
    }
    ...
    fn test_negative_infinity() {
        ...
        let b = ExtendedBigDecimal::from(f64::NEG_INFINITY);
        assert!(matches!(b, ExtendedBigDecimal::NegInf));

        let c = ExtendedBigDecimal::from_string("-infinity").unwrap();
        assert!(matches!(c, ExtendedBigDecimal::NegInf));
    }

    #[test]
    fn test_nan() {
        let a = ExtendedBigDecimal::from(f32::NAN);
        assert!(matches!(a, ExtendedBigDecimal::NaN));

        let b = ExtendedBigDecimal::from(f64::NAN);
        assert!(matches!(b, ExtendedBigDecimal::NaN));

        let c = ExtendedBigDecimal::from_string("nan").unwrap();
        assert!(matches!(c, ExtendedBigDecimal::NaN));
    ...
    #[test]
    fn test_finite() {
        let a = ExtendedBigDecimal::from(1.23f32);
        assert!(matches!(a, ExtendedBigDecimal::Finite(_)));

        let b = ExtendedBigDecimal::from(4.56f64);
        assert!(matches!(b, ExtendedBigDecimal::Finite(_)));

        let c = ExtendedBigDecimal::from_string("7.89").unwrap();
        assert!(matches!(c, ExtendedBigDecimal::Finite(_)));

        let d = ExtendedBigDecimal::from_string("-1.23").unwrap();
        assert!(matches!(d, ExtendedBigDecimal::Finite(_)));
    }
}
