...
use std::ops::Neg;
use num_traits::Zero;
use crate::datex_values::core_values::decimal_new::decimal::Decimal;
...
impl Add for TypedDecimal {
    ...
    fn add(self, rhs: Self) -> Self::Output {
        match self {
            ...
            TypedDecimal::Decimal(a) => TypedDecimal::Decimal(a + match rhs {
                TypedDecimal::F32(b) => Decimal::from(b.into_inner()),
                TypedDecimal::F64(b) => Decimal::from(b.into_inner()),
                TypedDecimal::Decimal(b) => b,
            }),
        }
    }
}
