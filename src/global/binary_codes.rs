...
pub enum InstructionCode {
    ...
    VAR_RESULT = 0x30,
    SET_VAR_RESULT = 0x31,
    SET_VAR_RESULT_REFERENCE = 0x32,
    VAR_RESULT_ACTION = 0x33,

    VAR_SUB_RESULT = 0x34,
    SET_VAR_SUB_RESULT = 0x35,
    SET_VAR_SUB_RESULT_REFERENCE = 0x36,
    VAR_SUB_RESULT_ACTION = 0x37,

    VAR_VOID = 0x38,
    SET_VAR_VOID = 0x39,
    SET_VAR_VOID_REFERENCE = 0x3a,
    VAR_VOID_ACTION = 0x3b,

    _VAR_ORIGIN = 0x3c,
    _SET_VAR_ORIGIN = 0x3d,
    _SET_VAR_ORIGIN_REFERENCE = 0x3e,
    ...
    RANGE = 0x74,                 // ..
    RESOLVE_RELATIVE_PATH = 0x75, // ./abc
    DO = 0x76,                    // do xy;
    ...
    // slots
    GET_SLOT = 0xa4, // #xyz   0x0000-0x00ff = variables passed on between scopes, 0x0100-0xfdff = normal variables, 0xfe00-0xffff = it variables (#it.0, #it.1, ...) for function arguments
    UPDATE_SLOT = 0xa5, // #aa = ...
    ALLOCATE_SLOT = 0xa6, // #aa = ...
    SLOT_ACTION = 0xa7, // #x += ...
    // SET_INTERNAL_VAR_REFERENCE = 0xa8, // #x $= ...
    ...
    PERSON_ALIAS = 0xcf,
    PERSON_ALIAS_WILDCARD = 0xd0,
    INSTITUTION_ALIAS = 0xd1,
    INSTITUTION_ALIAS_WILDCARD = 0xd2,
    BOT = 0xd3,
    BOT_WILDCARD = 0xd4,
