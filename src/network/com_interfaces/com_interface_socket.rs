...
use super::{com_interface::ComInterface, com_interface_properties::{InterfaceDirection, InterfaceProperties}};
...
impl ComInterfaceSocket {
	...
	pub fn can_send(&self) -> bool {
		let properties = self.interface.get_properties();
		return properties.direction == InterfaceDirection::OUT || properties.direction == InterfaceDirection::IN_OUT;
	}

	pub fn can_receive(&self) -> bool {
		let properties = self.interface.get_properties();
		return properties.direction == InterfaceDirection::IN || properties.direction == InterfaceDirection::IN_OUT;
	}
}